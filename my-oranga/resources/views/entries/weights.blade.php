...
<div class="container">
    ...
    <div class="row d-flex justify-content-right text-right">
        <div class="col-md-12 pb-4">
            <a href="{{route('weights.create')}}" class="btn btn-outline-success">Add Weight <i class="fa fa-plus fa-1x pl-2"></i></a>
        </div>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td>{{$entry->date}}</td>
                <td>{{$entry->kg}}</td>
                <td><a href="{{route('weights.edit', $entry->id)}}" class="btn btn-primary tbl-edit-btn"><i class="fas fa-edit fa-1x"></i></a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
